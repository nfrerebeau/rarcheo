...
* Le chapitre [-@sec-reproducibility] expose les motivations et modalités conduisant à mettre en œuvre une recherche ouverte et reproductible en archéologie (une bonne pratique pour la science en général, et pour votre productivité individuelle en particulier). Il est complété par les chapitres [-@sec-reproducibility-literate] et [-@sec-reproducibility-version] qui vous accompagneront vers la prise en main de deux concepts clés : la programmation lettrée et le contrôle de version.
* Les chapitres [-@sec-collect], [-@sec-collect-files] et [-@sec-collect-data] proposent un certain nombre de recommandations quant à l'organisation de votre travail en amont de l'analyse pour en faciliter la réalisation.
