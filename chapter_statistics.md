...
# Observations et variables {#variables}
...
\caption{Les types de variables.}(\#fig:variables)
\end{figure}
...
Les variables qualitatives représentent des caractéristiques non quantifiables, dont les valeurs sont appelées catégories ou *modalités*.
...
\caption{(ref:xkcd-correlation)}(\#fig:xkcd-correlation)
\end{figure}
...
\caption{(ref:xkcd-curve-fitting)}(\#fig:xkcd-curve-fitting)
\end{figure}
