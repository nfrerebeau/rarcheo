...
Les fonctions sont organisées en **packages**, que vous pouvez télécharger pour étendre l'utilisation de R. Lors d'une première installation de R, deux ensembles de packages contenant les [fonctions](#fonctions) fondamentales sont installés :
