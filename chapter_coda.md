...
\caption{(ref:mahalanobis-khi2)}(\#fig:mahalanobis-khi2)
\end{figure}
...
\caption{(ref:mahalanobis-robuste)}(\#fig:mahalanobis-robuste)
\end{figure}
...
\caption{(ref:mahalanobis-robuste)}(\#fig:mahalanobis-qqplot)
\end{figure}
